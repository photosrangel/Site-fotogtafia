...
export function AdminDashboard(){
  ...
  const openLegacy=()=>{const label=(document.activeElement?.textContent||'').toLocaleLowerCase('pt-PT');window.location.assign(label.includes('categorias')?'/admin/categorias':label.includes('galerias')||label.includes('galeria')?'/admin/galerias':'/legacy/admin-v2.html')};
