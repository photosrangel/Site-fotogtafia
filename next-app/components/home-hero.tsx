...
function mediaUrl(value:unknown,fallback:string){
  ...
  if(/^legacy\//i.test(normalized))return `/${normalized}`;
  if(/^images\//i.test(normalized))return `/legacy/${normalized}`;
